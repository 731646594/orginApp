    ...
    this.pageData = {
      ...
      pageItem:[
        [
          ...
          {itemName:"故障描述", itemType:"textarea",itemValue:"wxms",nec:0},
          {itemName:"备注", itemType:"label",itemValue:"bzxx",nec:0},
          {itemName:"单据来源", itemType:"label", itemValue:"djlyName",nec:0},
          {itemName:"维修预算", itemType:"label", itemValue:"ysze",nec:1},
          ...
          {itemName:"项目名称", itemType:"label",itemValue:"xmmc",nec:1},
          {itemName:"人工及配件费用", itemType:"label",itemValue:"rgfwf",nec:1},
