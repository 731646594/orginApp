...
import {DayReportSearchDetailPage} from "../dayReportSearchDetail/dayReportSearchDetail";

@Component({
  selector: 'page-dayReportSearch',
  templateUrl: 'dayReportSearch.html'
})
export class DayReportSearchPage {
  itemName = '日报日期';
  itemName2 = '目标部门';
  itemName3 = '统计状态';
  dateValue;
  ...
  stateData = [
    ...
    {stateName:"新建",stateCode:"1"},
    {stateName:"未补录",stateCode:"2"},
    {stateName:"补录完成",stateCode:"3"}
  ];
  dataList =[
    {
      "id": 10000018990002,
  ...
  goToDetail(i){
    this.app.getRootNav().push(DayReportSearchDetailPage,{data:this.dataList[i]})
  }
}
