...
import {DayReportSupplementDetailPage} from "../dayReportSupplementDetail/dayReportSupplementDetail";
import * as $ from "jquery";
import {DayReportSupplementAlertPage} from "../dayReportSupplementAlert/dayReportSupplementAlert";

@Component({
  selector: 'page-dayReportSupplement',
  templateUrl: 'dayReportSupplement.html'
})
export class DayReportSupplementPage {
  itemName = '日报日期';
  itemName2 = '目标部门';
  dateValue;
  departText="请选择";
  ...
  goToDetail(i){
    this.app.getRootNav().push(DayReportSupplementDetailPage,{data:this.dataList[i]})
  }
}
